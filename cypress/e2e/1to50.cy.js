...
describe("Traveloka Take Home Test", () => {
    it("Does Challenge using Automation Test for problem no.4", {scrollBehavior: "center"}, () => {
        for(let i=1; i <= numbers.length; i++) {
            cy.get(element).contains(i).scrollIntoView().click({force: true});
...
/*
    Somehow the test failed, as I stated on the PDF file. Since the click is not having any effect, the test will fail on the 26th iteration
*/